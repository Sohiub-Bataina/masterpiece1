...
Route::get('/load-more-pending-auctions', [UserSideAuctionController::class, 'loadMorePendingAuctions'])->name('loadMorePendingAuctions');
...
Route::middleware(['auth', 'role:customer'])->group(function () {
    ...
    Route::get('/user/bids', [UserSideBidController::class, 'index'])->name('user.bids')->middleware('auth');
